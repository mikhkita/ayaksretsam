...
$params["TITLE"] = 'Водолазка тонкой вязки';
		...
		<div class="b-detail-right stick">
			<div class="b-detail-small-img-list">
				...
				<div class="b-detail-small-img-list-cont">
					<div class="b-detail-small-img active" data-img="item-1" style="background-image: url('i/item-1.jpg');">
						<div class="b-detail-img-block"></div>
					</div>
					<div class="b-detail-small-img" data-img="item-2" style="background-image: url('i/item-2.jpg');">
						<div class="b-detail-img-block"></div>
					</div>
					<div class="b-detail-small-img" data-img="item-3" style="background-image: url('i/item-3.jpg');">
						<div class="b-detail-img-block"></div>
					</div>
					<div class="b-detail-small-img" data-img="item-4" style="background-image: url('i/item-4.jpg');">
						<div class="b-detail-img-block"></div>
					</div>
					<div class="b-detail-small-img" data-img="item-5" style="background-image: url('i/item-5.jpg');">
						<div class="b-detail-img-block"></div>
					</div>
				</div>
			</div>
			...
			<div class="b-slider-with-descr-inner-cont" id="id1">
				<div class="b-slider-with-descr-inner">
					...
					<a href="#" class="b-catalog-item">
						<div class="b-catalog-item-img">
							<img src="i/item-2.jpg">
							<img src="i/item-9.jpg" class="hover">
						</div>
						<div class="b-catalog-item-text">Тёмно-зеленое платье</div>
						<div class="b-catalog-item-text">12 800 руб.</div>
					</a>
					<a href="#" class="b-catalog-item">
						<div class="b-catalog-item-img">
							<img src="i/item-1.jpg">
							<img src="i/item-10.jpg" class="hover">
						</div>
						<div class="b-catalog-item-text">Платье розовое волшебство</div>
						<div class="b-catalog-item-text">16 500 руб.</div>
					</a>
